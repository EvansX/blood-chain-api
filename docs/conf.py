...
html_context = {
    ...
    "github_repo": "blood-chain-api", # Repo name
...
htmlhelp_basename = 'BloodChain_doc'
...
latex_documents = [
  (master_doc, 'BloodChain.tex', u'BloodChain Documentation',
   u'BloodChain', 'manual'),
]
...
man_pages = [
    (master_doc, 'BloodChain', u'BloodChain Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'BloodChain', u'BloodChain Documentation',
   author, 'BloodChain', 'documents of BloodChain',
   'Miscellaneous'),
]
